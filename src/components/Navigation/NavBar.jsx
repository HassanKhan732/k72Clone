  ...
  return (
    <div className='z-[4] flex fixed top-0 w-full items-start justify-between'>
      ...
      <div
        ...
        className='h-12 w-[17vw] relative bg-black cursor-pointer'
      >
        <div
          ref={NavGrenRef}
          className='bg-[#D3FD50] text-white w-full absolute top-0 transition-all duration-300 ease-in-out overflow-hidden'
          style={{ height: '0%' }}
        >
        ...
        <FaBars className='' size={24} color="white" />
